...
function Bingo.LoadDefaultBingoCards()
    BingoCards = {
        Default = {
            ...
            [4]  = { value = "Early Pull",                 size = 18 },
            [5]  = { value = "Game Crash",                 size = 16 },
            [6]  = { value = "Other Right",                size = 18 },
            [7]  = { value = "Clear Comms" },
            [8]  = { value = "Pull Jinxed" },
            [9]  = { value = "Timezone War",               size = 15 },
            [10]  = { value = "Spouse Aggro" },
            [11]  = { value = "<Vod Review>",               size = 14 },
            [12] = { value = "HR Requested",               size = 14 },
            [13] = { value = "Tech Support" },
            [14] = { value = "Xäku Unhinged",              size = 16 },
            [15] = { value = "Bug Mentioned",              size = 12 },
            [16] = { value = "Blue Bar Boss" },
            [17] = { value = "Repair Please" },
            [18] = { value = "Wiped to Trash" },
            [19] = { value = "Guess Who Died",             size = 18 },
            ...
            [26] = { value = "Skill Not on Bar" },
            [27] = { value = "Addon Out of Date" },
            [28] = { value = "Raidlead Hijacked",          size = 14 },
            ...
            [45] = { value = "PooPoo no talk all night",   size = 14, players = { "LegitPooPoo", "Legitsozzled" }},
            [46] = { value = "Vibekiller Enters the Chat", size = 13, players = { "Tencarus", "Tencdh" }},
        }
    }
end
