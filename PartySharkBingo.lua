...
function Bingo.LoadDefaultBingoCards()
    BingoCards = {
        Default = {
            ...
            [6]  = { value = "Clear Comms" },
            [7]  = { value = "Pull Jinxed" },
            [5]  = { value = "Spouse Aggro" },
            [8]  = { value = "<Vod Review>",               size = 14 },
            [9]  = { value = "HR Requested",               size = 14 },
            [10] = { value = "Tech Support" },
            [11] = { value = "Bug Mentioned",              size = 12 },
            [12] = { value = "Blue Bar Boss" },
            [13] = { value = "Repair Please" },
            [14] = { value = "Wiped to Trash" },
            [15] = { value = "Missed Consumes",            size = 13 },
            [16] = { value = "Last Pull Magic" },
            [17] = { value = "Healer Rez Race" },
            [18] = { value = "Name Said Wrong" },
            [19] = { value = "Rich People Talk" },
            [20] = { value = "Skill Not on Bar" },
            [21] = { value = "Addon Out of Date" },
            [22] = { value = "Raidlead Hijacked",          size = 14 },
            [23] = { value = "Mage Table Please" },
            [24] = { value = "Bingo Tile Fishing",         size = 16 },
            [25] = { value = "Substances Mentioned",       size = 12 },
            [26] = { value = "Don't Die to X; Dies to X",  size = 14 },
            [27] = { value = "3 ilvl",                     size = 24, players = { "Bälancedeez" }},
            [28] = { value = "Rez Dissar",                 size = 20, players = { "Dìssar" }},
            [29] = { value = "Tenc Stalks",                size = 20, players = { "Tencarus", "Tencdh" }},
            [30] = { value = "Shut Up Grun",               size = 19, players = { "Grunmore" }},
            [31] = { value = "PooPoo Speaks",              size = 18, players = { "LegitPooPoo", "Legitsozzled" }},
            ...
            [41] = { value = "Bitching Boomkin",           size = 14, players = { "Bälancedeez" }},
            [36] = { value = "Keize Wasn't Healed",        size = 15, players = { "Keize" }},
            [37] = { value = "Braainss' Jeeves, Eww",      size = 15, players = { "Braainss" }},
            [42] = { value = "Bitching Braainss",          size = 14, players = { "Braainss" }},
            [38] = { value = "Tenc 'Inspiring' Speech",    size = 14, players = { "Tencarus", "Tencdh" }},
            [39] = { value = "Yuhbarrel Speaks at 2.5x",   size = 13, players = { "Yvairel", "Yvauras" }},
            [40] = { value = "Vibekiller Enters the Chat", size = 13, players = { "Tencarus", "Tencdh" }},
        }
    }
end
