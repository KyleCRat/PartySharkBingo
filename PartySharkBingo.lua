...
function Bingo.LoadDefaultBingoCards()
    BingoCards = {
        Default = {
            ...
            [26] = { value = "Bingo Tile Fishing"          size = 16 },
            [24] = { value = "Substances Mentioned",       size = 12 },
            [25] = { value = "Don't Die to X; Dies to X",  size = 14 },
            [27] = { value = "3 ilvl"                      size = 24, players = { "GriffCHANGEME" }},
