...
function Bingo.LoadDefaultBingoCards()
    BingoCards = {
        Default = {
            ...
            [5]  = { value = "EST CST War",                size = 16 },
            [6]  = { value = "Clear Comms" },
            [7]  = { value = "Pull Jinxed" },
            [8]  = { value = "Spouse Aggro" },
            [9]  = { value = "<Vod Review>",               size = 14 },
            [10] = { value = "HR Requested",               size = 14 },
            [11] = { value = "Tech Support" },
            [12] = { value = "Bug Mentioned",              size = 12 },
            [13] = { value = "Blue Bar Boss" },
            [14] = { value = "Repair Please" },
            [15] = { value = "Wiped to Trash" },
            [16] = { value = "Missed Consumes",            size = 13 },
            [17] = { value = "Last Pull Magic" },
            [18] = { value = "Healer Rez Race" },
            [19] = { value = "Name Said Wrong" },
            [20] = { value = "Rich People Talk" },
            [21] = { value = "Skill Not on Bar" },
            [22] = { value = "Addon Out of Date" },
            [23] = { value = "Raidlead Hijacked",          size = 14 },
            [24] = { value = "Mage Table Please" },
            [25] = { value = "Bingo Tile Fishing",         size = 16 },
            [26] = { value = "Substances Mentioned",       size = 12 },
            [27] = { value = "Don't Die to X; Dies to X",  size = 14 },
            [28] = { value = "3 ilvl",                     size = 24, players = { "Bälancedeez" }},
            [29] = { value = "Rez Dissar",                 size = 20, players = { "Dìssar" }},
            [30] = { value = "Tenc Stalks",                size = 20, players = { "Tencarus", "Tencdh" }},
            [31] = { value = "Shut Up Grun",               size = 19, players = { "Grunmore" }},
            [32] = { value = "Guess Who Died",             size = 18, players = { "Rezy" }},
            [33] = { value = "Rezy Gets Bullied",          size = 17, players = { "Rezy" }},
            [34] = { value = "Plane Delays Nash",          size = 17, players = { "Nashou" }},
            [35] = { value = "Braainss' Vacation",         size = 15, players = { "Braainss" }},
            [36] = { value = "Bitching Boomkin",           size = 14, players = { "Bälancedeez" }},
            [37] = { value = "Keize Wasn't Healed",        size = 15, players = { "Keize" }},
            [38] = { value = "Braainss' Jeeves, Eww",      size = 15, players = { "Braainss" }},
            [39] = { value = "Bitching Braainss",          size = 14, players = { "Braainss" }},
            [40] = { value = "Tenc 'Inspiring' Speech",    size = 14, players = { "Tencarus", "Tencdh" }},
            [41] = { value = "Yuhbarrel Speaks at 2.5x",   size = 13, players = { "Yvairel", "Yvauras" }},
            [42] = { value = "PooPoo no talk all night",   size = 14, players = { "LegitPooPoo", "Legitsozzled" }},
            [43] = { value = "Vibekiller Enters the Chat", size = 13, players = { "Tencarus", "Tencdh" }},
        }
    }
end
